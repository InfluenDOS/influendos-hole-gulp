...
export class HoleView {
  ...
  constructor() {
    this.rimMat = new THREE.MeshStandardMaterial({ color: 0xb7a6ff, roughness: 0.35, metalness: 0.25, emissive: 0x2a2048, emissiveIntensity: 0.4 })
    this.lipMat = new THREE.MeshStandardMaterial({ color: 0x3a3158, roughness: 0.55, metalness: 0.1 })
    ...
    this.group.add(this.pit, this.floor, this.rim, this.lip, this.magnet, this.spark)
    for (let i = 0; i < 5; i++) {
